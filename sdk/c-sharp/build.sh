...
${nuget_cmd} install src/Co.GetAnchor.Sdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Co.GetAnchor.Sdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Co.GetAnchor.Sdk.dll \
-recurse:'src/Co.GetAnchor.Sdk/*.cs' \
-doc:bin/Co.GetAnchor.Sdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Co.GetAnchor.Sdk.dll was created successfully"
fi
